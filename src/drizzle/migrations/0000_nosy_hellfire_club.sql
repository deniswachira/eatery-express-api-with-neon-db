DO $$ BEGIN
 CREATE TYPE "public"."role" AS ENUM('admin', 'user', 'restaurant_owner', 'driver');
EXCEPTION
...
--> statement-breakpoint
CREATE TABLE IF NOT EXISTS "auth_on_users_table" (
	"auth_on_users_id" serial PRIMARY KEY NOT NULL,
	"user_id" integer NOT NULL,
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "auth_on_users_table" ADD CONSTRAINT "auth_on_users_table_user_id_user_table_user_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."user_table"("user_id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
